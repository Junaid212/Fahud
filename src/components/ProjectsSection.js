...
export default function ProjectsSection() {
  ...
  return (
    <>
      ...
      <div className="section-full p-t50 p-b90 pro-filtr-cate-wrap">
        {/* CATEGORY SECTION */}
      ...
      {/* CATEGORY END */}
        <div className="container">
          ...
          <div className="section-head center wt-small-separator-outer">
            ...
            <h2 className="wt-title">Our Products</h2>
          </div>
          {/* TITLE END */}
        </div>
        ...
        <div className="pro-filtr-cate-carousal-wrap">
          ...
          <div className="swiper-container pro-filtr-cate-bx" style={{ transition: 'opacity 0.3s ease-in-out' }}>
